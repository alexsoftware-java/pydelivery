...
class FancyMenu(object):
    def __init__(self):
        ...
        callback_button_ord = types.InlineKeyboardButton(text="Добавить", callback_data="add_to_cart")
        callback_button_right = types.InlineKeyboardButton(text="->", callback_data="to_right")
        # self.markup.add(callback_button_ord)
        self.markup.add(callback_button_left, callback_button_ord, callback_button_right)
